...
public class Room {
	...
	@NotNull(message="Room available cannot be null")
	...
	public Room(@NotNull(message="Room ID cannot be null")int roomId,
			@NotNull(message="Room type be null")@Size(min=11,message="Room type be minimum 11 digits")String roomType,
			@NotNull(message="Room rent cannot be null")@Size(min=4,message="Room rent should be minimum 4 digits")double roomRent,
			@NotNull(message="Room available cannot be null")@Size(min=5,message="Room available should be minimum 5 digits and should be either 'True' or 'False'")boolean roomAvailable) {
		super();
		this.roomId = roomId;
		this.roomType = roomType;
		this.roomRent = roomRent;
